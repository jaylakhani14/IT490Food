            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Search Recipe</h3>
                    ...
                    <div class="card-body">
                        <form id="search_form">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control mb-2" name="title"
                                           placeholder="search recipe title e.g burger">
                                </div>
                                <div class="col-md-4">
                                    <select name="includeIngredients[]" class="form-control select2"
                                            data-placeholder="Ingredients"
                                            multiple
                                    >
                                        <?php
                                ...
                                <div class="col-md-4">
                                    <select name="cuisine" class="form-control select2">
                                ...
                                <div class="col-md-4">
                                    <select name="type" class="form-control select2">
                                        <option selected disabled>Select Meal Types</option>
                                        <?php
                                        foreach (mealTypes() as $row) {
                                            ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-info mt-2 float-right" type="submit">Apply Filter</button>
                                </div>
                            </div>
                        </form>
